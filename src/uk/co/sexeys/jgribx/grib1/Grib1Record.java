 ...
 * ============================================================================
 */
package uk.co.sexeys.jgribx.grib1;

import uk.co.sexeys.jgribx.*;
...
public class Grib1Record extends GribRecord
{
    ...
    {
        return gds.getGridNX();
    }
    @Override
    public double getMinimumLongitude(){
        return gds.getGridLon1();
    }
    @Override
    public double getMaximumLongitude(){
        return gds.getGridLon2();

    }
    @Override
    public double getMinimumLatitude(){
        return gds.getGridLat1();

    }
    @Override
    public double getMaximumLatitude(){
        return gds.getGridLat2();
    }
}
